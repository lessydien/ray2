...
Vec3f ParabolicSurfaceItem::calcNormal(Vec3f vertex)
{
	// calc centre of sphere
	Vec3f orientation=Vec3f(0,0,1);
	Vec3f centre=Vec3f(0,0,0)+orientation*this->getRadius();
...
void ParabolicSurfaceItem::renderVtk(vtkSmartPointer<vtkRenderer> renderer)
{
...
void ParabolicSurfaceItem::updateVtk()
{
