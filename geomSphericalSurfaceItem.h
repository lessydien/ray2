...
#ifndef SPHERICALSURFACEITEM
#define SPHERICALSURFACEITEM
...
public:
	...
	SphericalSurfaceItem(QString name="SphericalSurface", QObject *parent=0);
	~SphericalSurfaceItem(void);
