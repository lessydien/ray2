...
////			sprintf( path_to_ptx_exception, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_exception.cu.ptx" );
...
//    /* Miss program */
//	sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_missFunction.cu.ptx" );
