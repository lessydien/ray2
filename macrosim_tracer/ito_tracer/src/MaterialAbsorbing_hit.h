...
#ifndef MATERIALABSORBING_HIT_H
#define MATERIALABSORBING_HIT_H
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitAbsorbing(rayStruct &ray, Mat_hitParams hitParams, double t_hit, int geomID)
{
