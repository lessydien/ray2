...
__forceinline__ __device__ void reflectingLambert2D_anyHit_device()
{
...
__forceinline__ __device__ void reflectingLambert2D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
	// reflect ray
...
{
  reflectingLambert2D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  reflectingLambert2D_closestHit_device( hitParams, t_hit ); 
}
