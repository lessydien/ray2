...
__forceinline__ __device__ void idealLenseScatTorrSparr1D_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseScatTorrSparr1D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  idealLenseScatTorrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseScatTorrSparr1D_closestHit_device( hitParams, t_hit );
}
