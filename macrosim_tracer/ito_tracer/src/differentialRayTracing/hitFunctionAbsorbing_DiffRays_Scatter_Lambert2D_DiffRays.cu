...
rtDeclareVariable(ScatLambert2D_DiffRays_params, scatterParams, , ); 
...
__forceinline__ __device__ void absorbingScatLambert2DDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void absorbingScatLambert2DDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
  ...
  hitLambert2D_DiffRays(prd, hitParams, scatterParams);  
...
{
  absorbingScatLambert2DDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingScatLambert2DDiffRays_closestHit_device( hitParams, t_hit ); 
}
