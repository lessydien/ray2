...
__forceinline__ __device__ void absorbingCoatNumCoeffsDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void absorbingCoatNumCoeffsDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  absorbingCoatNumCoeffsDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingCoatNumCoeffsDiffRays_closestHit_device( hitParams, t_hit );
}
