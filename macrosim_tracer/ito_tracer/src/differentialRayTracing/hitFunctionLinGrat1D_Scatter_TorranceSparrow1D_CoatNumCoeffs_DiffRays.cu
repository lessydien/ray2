...
__device__ void linGrat1D_torrSparr1D_anyHit_device()
{
...
__device__ void linGrat1D_torrSparr1D_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
  ...
  {
    rtPrintf("ray stopped in hitLinGrat1DScatter_TorranceSparrow1D!!");
...
{
  linGrat1D_torrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  linGrat1D_torrSparr1D_closestHit_device( hitParams, t_hit ); 
}
