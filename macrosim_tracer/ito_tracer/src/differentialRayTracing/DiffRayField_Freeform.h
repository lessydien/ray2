...
#define DIFFRAYFIELD_FREEFORM_PATHTOPTX "macrosim_tracer_generated_rayGenerationDiffRayField_Freeform.cu.ptx"
...
class DiffRayField_Freeform : public DiffRayField
{
  ...
  public:
	...
	{
		sprintf( path_to_ptx_rayGeneration, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, DIFFRAYFIELD_FREEFORM_PATHTOPTX );		
		// init random seed
