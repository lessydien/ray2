...
__forceinline__ __device__ void absorbingScatTorrSparr1DCoatNumCoeffsDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void absorbingScatTorrSparr1DCoatNumCoeffsDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
  ...
  if (hitCoatingNumCoeff_DiffRays(prd, hitParams, coating_params))
...
{
  absorbingScatTorrSparr1DCoatNumCoeffsDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingScatTorrSparr1DCoatNumCoeffsDiffRays_closestHit_device( hitParams, t_hit );
}
