...
__forceinline__ __device__ void idealLenseScatTorrSparr1DDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseScatTorrSparr1DDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
  rtPrintf("closest hit ID %i \n", geometryID);
  rtPrintf("flux %.20lf \n", prd.flux);
  hitIdealLense(prd, hitParams, params, t_hit, geometryID, false);
...
{
  idealLenseScatTorrSparr1DDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseScatTorrSparr1DDiffRays_closestHit_device( hitParams, t_hit );
}
