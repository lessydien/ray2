...
__forceinline__ __device__ void linearGrating1DDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void linearGrating1DDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
    bool reflected;
    if (params.nRefr1==0)
		reflected=true;
...
{
  linearGrating1DDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  linearGrating1DDiffRays_closestHit_device( hitParams, t_hit );
}
