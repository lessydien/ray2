...
//	  paramsPtr=new SphericalSurface_DiffRays_Params();
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_SphericalSurface_DiffRays.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_SphericalSurface_DiffRays.cu.ptx" );
