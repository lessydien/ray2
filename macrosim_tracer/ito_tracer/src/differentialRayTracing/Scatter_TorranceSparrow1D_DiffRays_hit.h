...
#ifndef SCATTER_TORRANCESPARROW1D_DIFFRAYS_HIT_H
  #define SCATTER_TORRANCESPARROW1D_DIFFRAYS_HIT_H
...
/* declare class */
/**
  *\class   ScatTorranceSparrow1D_DiffRays_params
  *\ingroup Scatter
  ...
  *
  */
class ScatTorranceSparrow1D_DiffRays_params: public ScatTorranceSparrow1D_params
{
public:
...
/**
 * \detail hitTorranceSparrow1D_DiffRays 
 *
 * modifies the raydata according to the parameters of the scatter
 *
 * \param[in] diffRayStruct &prd, Mat_DiffRays_hitParams hitParams, ScatTorranceSparrow1D_params params
 * 
 * \return bool
 * \sa 
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitTorranceSparrow1D_DiffRays(diffRayStruct &prd, Mat_DiffRays_hitParams hitParams, ScatTorranceSparrow1D_params params)
{
	// do the geometric hit
	if (!hitTorranceSparrow1D(prd, hitParams, params) )
		return false;
