...
__device__ void absorbing_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  absorbing_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbing_closestHit_device( hitParams, t_hit ); 
}
