...
__device__ void refracting_torrSparr1D_anyHit_device()
{
...
__device__ void refracting_torrSparr1D_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
  ...
  {
	rtPrintf("ray stopped in hitRferacting_Scatter!!");
...
{
  refracting_torrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refracting_torrSparr1D_closestHit_device( hitParams, t_hit ); 
}
