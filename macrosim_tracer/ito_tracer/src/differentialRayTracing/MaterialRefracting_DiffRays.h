...
#define PATH_TO_HIT_REFRACTING_DIFFRAYS "macrosim_tracer_generated_hitFunctionRefracting"
...
//		path_to_ptx[512];
		sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, PATH_TO_HIT_REFRACTING_DIFFRAYS );
