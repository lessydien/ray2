...
private:
  ...
  public:
    ...
    PlaneSurface()
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_PlaneSurface.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_PlaneSurface.cu.ptx" );
	  type=GEOM_PLANESURF;
	}
