...
__forceinline__ __device__ void linearGrating1D_anyHit_device()
{
...
__forceinline__ __device__ void linearGrating1D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
    bool reflected;
    if (params.nRefr1==0)
		reflected=true;
