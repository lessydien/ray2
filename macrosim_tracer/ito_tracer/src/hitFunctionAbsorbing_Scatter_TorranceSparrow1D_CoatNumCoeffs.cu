...
__forceinline__ __device__ void absorbingScatTorrSparr1DCoatNumCoeffs_anyHit_device()
{
...
__forceinline__ __device__ void absorbingScatTorrSparr1DCoatNumCoeffs_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  absorbingScatTorrSparr1DCoatNumCoeffs_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingScatTorrSparr1DCoatNumCoeffs_closestHit_device( hitParams, t_hit );
}
