...
__forceinline__ __device__ void linGrat1DScatDoubleCauchy_anyHit_device()
{
...
__forceinline__ __device__ void linGrat1DScatDoubleCauchy_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  linGrat1DScatDoubleCauchy_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  linGrat1DScatDoubleCauchy_closestHit_device( hitParams, t_hit );
}
