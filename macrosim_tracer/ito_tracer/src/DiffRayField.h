...
#define DIFFRAYFIELD_PATHTOPTX "macrosim_tracer_generated_rayGenerationDiffRayField.cu.ptx"
...
class DiffRayField : public RayField
{
  ...
  public:
    ...
    DiffRayField()
	{
		sprintf( path_to_ptx_rayGeneration, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, DIFFRAYFIELD_PATHTOPTX );		
		// init random seed
