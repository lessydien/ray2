...
private:
  ...
  public:
    ...
    CylPipe()
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_CylPipe.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_boundingBox.cu.ptx" );
	  type=GEOM_CYLPIPE;
	}
