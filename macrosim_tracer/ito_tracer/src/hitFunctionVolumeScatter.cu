...
rtDeclareVariable(MatVolumeScatter_params,               params, , );

/****************************************************************************/
/*				device functions											*/
/****************************************************************************/

__forceinline__ __device__ void volumeScatter_anyHit_device()
{
...
__forceinline__ __device__ void volumeScatter_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
  rtPrintf("closest hit ID %i \n", geometryID);
  rtPrintf("flux %.20lf \n", prd.flux);
  hitVolumeScatter(prd, hitParams, params, t_hit, geometryID, false);
}
...
{
  volumeScatter_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  volumeScatter_closestHit_device( hitParams, t_hit );
}
