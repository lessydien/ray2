...
__forceinline__ __device__ void refractingCoatNumCoeffsGeomRender_anyHit_device()
{
...
__forceinline__ __device__ void refractingCoatNumCoeffsGeomRender_closestHit_device( Mat_GeomRender_hitParams hitParams, double t_hit )
{
...
{
  refractingCoatNumCoeffsGeomRender_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refractingCoatNumCoeffsGeomRender_closestHit_device( hitParams, t_hit );
}
