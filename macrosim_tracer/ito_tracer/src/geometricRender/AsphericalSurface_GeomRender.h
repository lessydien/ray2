...
class AsphericalSurface_GeomRender : public AsphericalSurface
{
  ...
  public:
    ...
    AsphericalSurface_GeomRender() :
        AsphericalSurface()
	{
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_AsphericalSurface_GeomRender.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_AsphericalSurface_GeomRender.cu.ptx" );
	}
