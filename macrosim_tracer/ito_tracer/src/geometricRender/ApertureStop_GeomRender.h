...
private:
  ...
  public:
    ...
    ApertureStop_GeomRender() :
        ApertureStop()
	{
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_ApertureStop_GeomRender.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_ApertureStop_GeomRender.cu.ptx" );
	}
