...
__forceinline__ __device__ void absorbingCoatNumCoeffsGeomRender_anyHit_device()
{
...
__forceinline__ __device__ void absorbingCoatNumCoeffsGeomRender_closestHit_device( Mat_GeomRender_hitParams hitParams, double t_hit )
{
  ...
  if (hitCoatingNumCoeff_GeomRender(prd, hitParams, coating_params))
...
{
  absorbingCoatNumCoeffsGeomRender_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingCoatNumCoeffsGeomRender_closestHit_device( hitParams, t_hit );
}
