...
#ifndef CONEPIPE_GEOMRENDER_INTERSECT_H
  #define CONEPIPE_GEOMRENDER_INTERSECT_H
...
/* declare class */
/**
  *\class   ConePipe_GeomRender_ReducedParams 
  *\ingroup Geometry
  ...
  *
  */
class ConePipe_GeomRender_ReducedParams : public ConePipe_ReducedParams
{
  public:
