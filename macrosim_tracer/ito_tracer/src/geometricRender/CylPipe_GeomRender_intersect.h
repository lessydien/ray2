...
#ifndef CYLPIPE_GEOMRENDER_INTERSECT_H
  #define CYLPIPE_GEOMRENDER_INTERSECT_H
...
/* declare class */
/**
  *\class   CylPipe_GeomRender_ReducedParams
  *\ingroup Geometry
  ...
  *
  */
class CylPipe_GeomRender_ReducedParams : public CylPipe_ReducedParams
{
  public:
};
