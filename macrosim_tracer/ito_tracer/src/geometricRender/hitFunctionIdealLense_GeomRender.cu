...
__forceinline__ __device__ void idealLenseGeomRender_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseGeomRender_closestHit_device( Mat_GeomRender_hitParams hitParams, double t_hit )
{
...
{
  idealLenseGeomRender_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseGeomRender_closestHit_device( hitParams, t_hit );
}
