...
/**\file MaterialRefracting_GeomRender.h
* \brief 
* 
*           
* \author Mauch
...
#ifndef MATERIALREFRACTING_GEMORENDER_H
#define MATERIALREFRACTING_GEOMRENDER_H
...
#define PATH_TO_HIT_REFRACTING_GEOMRENDER "macrosim_tracer_generated_hitFunctionRefracting"
...
//  *
//  */
//class MatRefracting_GeomRender_DispersionParams : public MatDispersionParams
//{
//public:
...
/* declare class */
/**
  *\class   MaterialRefracting_GeomRender 
  *\ingroup Material
  *\brief   
  *
  *         
  ...
  *
  */
class MaterialRefracting_GeomRender: public MaterialRefracting
{
	protected:
		//MatRefracting_GeomRender_params params; // reduced parameter set for the ray trac ( on GPU )
		//MatRefracting_GeomRender_DispersionParams *glassDispersionParamsPtr; // complete parameter set for glass material
		//MatRefracting_GeomRender_DispersionParams *immersionDispersionParamsPtr; // complete parameter set for immersion medium
  ...
  public:
    ...
    MaterialRefracting_GeomRender()
	{
		params.n1=1;
		params.n2=1;
		/* set ptx path for OptiX calculations */
//		path_to_ptx[512];
		sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, PATH_TO_HIT_REFRACTING_GEOMRENDER );
