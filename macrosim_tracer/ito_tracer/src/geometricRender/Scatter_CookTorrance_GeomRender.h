...
/**\file Scatter_CookTorrance_GeomRender.h
* \brief 
* 
*           
* \author Mauch
...
#ifndef SCATTER_COOKTORRANCE_GEOMRENDER_H
#define SCATTER_COOKTORRANCE_GEOMRENDER_H
...
#define PATH_TO_HIT_SCATTER_COOKTORRANCE_GEOMRENDER "_Scatter_CookTorrance_GeomRender"
...
/* declare class */
/**
  *\class   Scatter_CookTorrance_GeomRender
  *\ingroup Scatter
  *\brief   
  *
  *         
  ...
  *
  */
class Scatter_CookTorrance_GeomRender: public Scatter_CookTorrance
{
	protected:
...
//		ScatLambert2D_scatParams *fullParamsPtr; // complete parameter set
  ...
  public:
    ...
    Scatter_CookTorrance_GeomRender()
	{
        reducedParams.coefLambertian=0;
		/* set ptx path for OptiX calculations */
		path_to_ptx[512];
		sprintf( path_to_ptx, "%s", PATH_TO_HIT_SCATTER_COOKTORRANCE_GEOMRENDER );
