...
#ifndef IDEALLENSE_GEOMRENDER_INTERSECT_H
  #define IDEALLENSE_GEOMRENDER_INTERSECT_H
...
/* declare class */
/**
  *\class   IdealLense_GeomRender_ReducedParams
  *\ingroup Geometry
  ...
  *
  */
class IdealLense_GeomRender_ReducedParams : public IdealLense_ReducedParams
{
  public:
};
