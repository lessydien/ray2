...
__forceinline__ __device__ void reflectingGeomRender_anyHit_device()
{
...
__forceinline__ __device__ void reflectingGeomRender_closestHit_device( Mat_GeomRender_hitParams hitParams, double t_hit )
{
  // reflection ray
...
{
  reflectingGeomRender_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  reflectingGeomRender_closestHit_device( hitParams, t_hit );
}
