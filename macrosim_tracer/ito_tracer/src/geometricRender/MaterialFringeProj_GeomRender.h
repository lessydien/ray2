...
/**\file MaterialFringeProj_GeomRender.h
* \brief 
* 
*           
* \author Mauch
...
#ifndef MATERIALRENDERFRINGEPROJ_H
#define MATERIALRENDERFRINGEPROJ_H

#include "..\Material.h"
#include <sampleConfig.h>
#include <stdio.h>
#include "..\Group.h"
#include "MaterialFringeProj_GeomRender_hit.h"

#define PATH_TO_HIT_RENDERLIGHT "macrosim_tracer_generated_hitFunctionRenderFringeProj"

/* declare class */
/**
  *\class   MaterialFringeProj_GeomRender
  *\ingroup Material
  *\brief   
  *
  *         
  ...
  *
  */
class MaterialFringeProj_GeomRender: public Material
{
	protected:
  ...
  public:
	...
	MatFringeProj_GeomRender_params getParams(void);
...
private:
    FringeType asciiToFringeType(const char* ascii) const;
    Orientation asciiToOrientation(const char* ascii) const;
