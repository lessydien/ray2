...
#define DIFFRAYFIELD_RAYAIMING_HOLO_PATHTOPTX "macrosim_tracer_generated_rayGenerationDiffRayField_RayAiming_Holo.cu.ptx"
...
//	Pupil **pupilList;
  ...
  public:
	...
	{
		sprintf( path_to_ptx_rayGeneration, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, DIFFRAYFIELD_RAYAIMING_HOLO_PATHTOPTX );		
		// init random seed
