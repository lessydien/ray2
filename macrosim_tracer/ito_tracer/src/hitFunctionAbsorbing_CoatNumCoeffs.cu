...
__forceinline__ __device__ void absorbingCoatNumCoeffs_anyHit_device()
{
...
__forceinline__ __device__ void absorbingCoatNumCoeffs_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
