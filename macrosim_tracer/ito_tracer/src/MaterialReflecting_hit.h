...
#ifndef MATERIALREFLECTING_HIT_H
#define MATERIALREFLECTING_HIT_H
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitReflecting(rayStruct &ray, Mat_hitParams hitParams, double t_hit, int geometryID, bool coat_reflected)
{
