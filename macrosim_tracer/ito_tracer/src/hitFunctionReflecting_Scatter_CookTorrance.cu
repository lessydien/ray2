...
__forceinline__ __device__ void reflectingCookTorrance_anyHit_device()
{
...
__forceinline__ __device__ void reflectingCookTorrance_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
	// reflect ray
	hitReflecting(prd, hitParams, t_hit, geometryID, true);

	// scatter ray
	hitCookTorrance(prd, hitParams, scatterParams);
...
{
  reflectingCookTorrance_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  reflectingCookTorrance_closestHit_device( hitParams, t_hit ); 
}
