...
__forceinline__ __device__ void absorbingScatTorrSparr1D_anyHit_device()
{
...
__forceinline__ __device__ void absorbingScatTorrSparr1D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  absorbingScatTorrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingScatTorrSparr1D_closestHit_device( hitParams, t_hit );
}
