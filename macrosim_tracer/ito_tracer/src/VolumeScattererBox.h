...
private:
  ...
  public:
    ...
    VolumeScattererBox()
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_VolumeScattererBox.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "macrosim_tracer_generated_VolumeScattererBox.cu.ptx" );
	  type=GEOM_PLANESURF;
	}
