...
//	bool test=connect(m_model, SIGNAL(dataChanged(QModelIndex, QModelIndex)), this, SLOT(changeModel(QModelIndex, QModelIndex)));
}
...
//void QPropertyEditorWidget::changeModel(const QModelIndex &topLeft, const QModelIndex &bottomRight)
//{
