...
public:
	...
	enum FieldType {UNDEFINED, RAYFIELD, GEOMRAYFIELD, GEOMRAYFIELD_PSEUDOBANDWIDTH, DIFFRAYFIELD, DIFFRAYFIELDRAYAIM, PATHTRACERAYFIELD, INTENSITYFIELD, SCALARFIELD, VECFIELD, SCALARPLANEWAVE, SCALARSPHERICALWAVE, SCALARGAUSSIANWAVE, SCALARUSERWAVE, PATHINTTISSUERAYFIELD};
