...
MaterialRefractingItem::MaterialRefractingItem(double n1, double n2, QString name, QObject *parent) :
...
MaterialRefractingItem::~MaterialRefractingItem()
{
}

bool MaterialRefractingItem::writeToXML(QDomDocument &document, QDomElement &root) const
{
	...
	material.setAttribute("materialType", "REFRACTING");
...
bool MaterialRefractingItem::readFromXML(const QDomElement &node)
{
