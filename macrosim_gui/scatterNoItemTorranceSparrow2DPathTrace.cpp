...
ScatterTorrSparr2DPathTraceItem::ScatterTorrSparr2DPathTraceItem(QString name, QObject *parent) :
	ScatterItem(TORRSPARR2D, name, parent)
{
}


ScatterTorrSparr2DPathTraceItem::~ScatterTorrSparr2DPathTraceItem()
{
}

bool ScatterTorrSparr2DPathTraceItem::writeToXML(QDomDocument &document, QDomElement &root) const
{
