...
#ifndef SCATTERTORRSPARR2DITEM
#define SCATTERTORRSPARR2DITEM
...
public:
	...
	ScatterTorrSparr2DItem(QString name="TorrSparr2D", QObject *parent=0);
	~ScatterTorrSparr2DItem(void);
