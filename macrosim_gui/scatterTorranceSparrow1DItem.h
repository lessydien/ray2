...
#ifndef SCATTERTORRSPARR1DITEM
#define SCATTERTORRSPARR1DITEM
	...
	public ScatterItem
{
	...
	Q_PROPERTY(Vec3d scatAxis READ getScatAxis WRITE setScatAxis DESIGNABLE true USER true);

public:

	ScatterTorrSparr1DItem(QString name="TorrSparr1D", QObject *parent=0);
	~ScatterTorrSparr1DItem(void);
