...
#ifndef SCALARUSERFIELDITEM
#define SCALARUSERFIELDITEM
...
public:
	...
	ScalarUserFieldItem(QString name="ScalarUserField", QObject *parent=0);
	~ScalarUserFieldItem(void);
