...
__forceinline__ __device__ void idealLense_anyHit_device()
{
...
__forceinline__ __device__ void idealLense_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  idealLense_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLense_closestHit_device( hitParams, t_hit );
}
