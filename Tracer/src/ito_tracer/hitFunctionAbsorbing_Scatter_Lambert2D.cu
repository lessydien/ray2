...
__forceinline__ __device__ void absorbingScatLambert2D_anyHit_device()
{
...
__forceinline__ __device__ void absorbingScatLambert2D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
  ...
  hitLambert2D(prd, hitParams, scatterParams);  
...
{
  absorbingScatLambert2D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingScatLambert2D_closestHit_device( hitParams, t_hit ); 
}
