...
__forceinline__ __device__ void absorbing_anyHit_device()
{
...
__forceinline__ __device__ void absorbing_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
