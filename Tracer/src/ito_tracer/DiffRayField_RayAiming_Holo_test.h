...
#define DIFFRAYFIELD_RAYAIMING_HOLO_TEST_PATHTOPTX "ITO-MacroSim_generated_rayGenerationDiffRayField_RayAiming_Holo_test.cu.ptx"
...
//	Pupil **pupilList;
  ...
  public:
	...
	{
		sprintf( path_to_ptx_rayGeneration, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, DIFFRAYFIELD_RAYAIMING_HOLO_TEST_PATHTOPTX );		
		// init random seed
