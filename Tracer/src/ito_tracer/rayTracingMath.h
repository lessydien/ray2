...
inline RT_HOSTDEVICE double3 calcSnellsLaw(double3 rayDirection, double3 interfaceNormal, double ni, double no)
{
 ...
 //   return (rayDirection+2*cosPhiIn*interfaceNormal);
 // }
 // else
 // {
	///* calc the refraction */
	//return (q*rayDirection+interfaceNormal*(cosPhiOut-q*cosPhiIn));
 // }
 ...
 return mu*rayDirection+gamma_r*interfaceNormal;
}
