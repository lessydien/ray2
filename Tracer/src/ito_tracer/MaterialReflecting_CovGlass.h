...
#define PATH_TO_HIT_REFLECTING_COVGLASS "ITO-MacroSim_generated_hitFunctionReflecting_CovGlass"
...
//		path_to_ptx[512];
		sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, PATH_TO_HIT_REFLECTING_COVGLASS );
