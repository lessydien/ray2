...
{
    if (hitCoatingNumCoeff(prd, hitParams, coating_params)) // see weter coating wants this material to be reflecting
		hitReflecting(prd, hitParams, t_hit, geometryID); // if coating wants reflections, reflect. otherwise don't alter the rays direction
