...
private:
  ...
  public:
    ...
    CylLenseSurface()
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, "ITO-MacroSim_generated_CylPipe.cu.ptx" );
    ...
    CylLenseSurface(int length)
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, "ITO-MacroSim_generated_CylLenseSurface.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, "ITO-MacroSim_generated_boundingBox.cu.ptx" );
	  type=GEOM_CYLLENSE;
	}
	/* Destruktor */
