...
////			sprintf( path_to_ptx_exception, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, "ITO-MacroSim_generated_exception.cu.ptx" );
...
//    /* Miss program */
//	sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, "ITO-MacroSim_generated_missFunction.cu.ptx" );
