...
__forceinline__ __device__ void reflectingScatTorrSparr1D_anyHit_device()
{
...
__forceinline__ __device__ void reflectingScatTorrSparr1D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
	// reflect ray
...
{
  reflectingScatTorrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  reflectingScatTorrSparr1D_closestHit_device( hitParams, t_hit ); 
}
