...
__forceinline__ __device__ void linGrat1DScatTorrSparr1DDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void linGrat1DScatTorrSparr1DDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  linGrat1DScatTorrSparr1DDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  linGrat1DScatTorrSparr1DDiffRays_closestHit_device( hitParams, t_hit ); 
}
