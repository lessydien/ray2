...
__forceinline__ __device__ void idealLenseDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  idealLenseDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseDiffRays_closestHit_device( hitParams, t_hit );
}
