...
__forceinline__ __device__ void idealLenseScatTorrSparr1DNumCoeffsDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseScatTorrSparr1DNumCoeffsDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  idealLenseScatTorrSparr1DNumCoeffsDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseScatTorrSparr1DNumCoeffsDiffRays_closestHit_device( hitParams, t_hit );
}
