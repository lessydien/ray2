...
__forceinline__ __device__ void refractingCoatNumCoeffsDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void refractingCoatNumCoeffsDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
{
  refractingCoatNumCoeffsDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refractingCoatNumCoeffsDiffRays_closestHit_device( hitParams, t_hit );
}
