...
/**\file MaterialRefracting_DiffRays.cpp
 ...
 * \author Mauch
 */
void MaterialRefracting_DiffRays::hit(diffRayStruct &ray, Mat_DiffRays_hitParams hitParams, double t_hit, int geometryID)
{
//	extern Group oGroup;
	...
	if ( hitRefracting_DiffRays(ray, hitParams, params, t_hit, geometryID, coat_reflected) )
	{
