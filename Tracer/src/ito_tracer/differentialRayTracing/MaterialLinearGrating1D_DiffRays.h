...
#define PATH_TO_HIT_LINEARGRATING1D_DIFFRAYS "ITO-MacroSim_generated_hitFunctionLinGrat1D"
...
//		path_to_ptx[512];
		sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, PATH_TO_HIT_LINEARGRATING1D_DIFFRAYS );
