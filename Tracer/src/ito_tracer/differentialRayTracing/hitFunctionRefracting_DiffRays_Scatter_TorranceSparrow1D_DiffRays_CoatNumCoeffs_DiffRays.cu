...
__forceinline__ __device__ void refractingScatTorrSparr1DCoatNumCoeffsDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void refractingScatTorrSparr1DCoatNumCoeffsDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{

    bool coat_reflected=hitCoatingNumCoeff_DiffRays(prd, hitParams, coating_params); // see wether coating demands reflection...
    // refract ray
...
{
  refractingScatTorrSparr1DCoatNumCoeffsDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refractingScatTorrSparr1DCoatNumCoeffsDiffRays_closestHit_device( hitParams, t_hit ); 
}
