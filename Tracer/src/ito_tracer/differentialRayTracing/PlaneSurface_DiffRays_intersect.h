...
#ifndef PLANESURFACE_DIFFRAYS_INTERSECT_H
  #define PLANESURFACE_DIFFRAYS_INTERSECT_H
...
/* declare class */
/**
  *\class   PlaneSurface_DiffRays_ReducedParams 
  *\ingroup Geometry
  ...
  *
  */
class PlaneSurface_DiffRays_ReducedParams : public PlaneSurface_ReducedParams
{
  public:
   double3 tilt;
};
 ...
 *
 * \param[in] double3 rayPosition, double3 rayDirection, PlaneSurface_DiffRays_ReducedParams params
 * 
 * \return double t
 * \sa 
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE double intersectRayPlaneSurface_DiffRays(double3 rayPosition, double3 rayDirection, PlaneSurface_DiffRays_ReducedParams params)
{
