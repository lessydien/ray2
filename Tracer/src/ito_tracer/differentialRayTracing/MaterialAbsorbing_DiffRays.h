...
#define PATH_TO_HIT_ABSORBING_DIFFRAYS "ITO-MacroSim_generated_hitFunctionAbsorbing"
...
class MaterialAbsorbing_DiffRays: public MaterialAbsorbing
{
  ...
  public:
    ...
    MaterialAbsorbing_DiffRays()
	{
		...
		//path_to_ptx[512];
		sprintf( path_to_ptx, "%s" PATH_SEPARATOR "%s", SAMPLES_PTX_DIR, PATH_TO_HIT_ABSORBING_DIFFRAYS );
