...
__forceinline__ __device__ void absorbingDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void absorbingDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
RT_PROGRAM void anyHit()
{
  ...
  absorbingDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingDiffRays_closestHit_device( hitParams, t_hit );
}
