...
void MaterialAbsorbing::hit(rayStruct &ray, double3 normal)
{
...
MaterialError MaterialAbsorbing::createOptiXInstance(RTcontext context, RTgeometryinstance &instance, int index)
{
