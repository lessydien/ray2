...
RT_PROGRAM void intersect(int)
{
  ...
  t.t_baseRay = intersectRayConePipe(prd.baseRay.position, prd.baseRay.direction, params);
  ...
  if( rtPotentialIntersection( (float)t.t_baseRay ) ) 
  {
	...
	t.t_waistRayX = intersectRayConePipe(prd.waistRayX.position, prd.waistRayX.direction, params);
	t.t_waistRayY = intersectRayConePipe(prd.waistRayY.position, prd.waistRayY.direction, params);
	t.t_divRayX = intersectRayConePipe(prd.divRayX.position, prd.divRayX.direction, params);
	t.t_divRayY = intersectRayConePipe(prd.divRayY.position, prd.divRayY.direction, params);
	/**************************************************************************************************************/
