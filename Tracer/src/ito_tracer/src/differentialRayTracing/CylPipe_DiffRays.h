...
//	  paramsPtr=new CylPipe_DiffRays_Params();
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_CylPipe_DiffRays.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_CylPipe_DiffRays.cu.ptx" );
	  type=GEOM_CYLPIPE;
	}
