...
__forceinline__ __device__ void refractingDiffRays_anyHit_device()
{
...
__forceinline__ __device__ void refractingDiffRays_closestHit_device( Mat_DiffRays_hitParams hitParams, double t_hit )
{
...
RT_PROGRAM void anyHit()
{
  ...
  refractingDiffRays_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refractingDiffRays_closestHit_device( hitParams, t_hit );
}
