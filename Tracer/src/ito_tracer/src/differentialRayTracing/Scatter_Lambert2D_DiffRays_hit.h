...
/* declare class */
/**
  *\class   ScatLambert2D_DiffRays_params
  *\ingroup Scatter
  ...
  *
  */
class ScatLambert2D_DiffRays_params: public ScatLambert2D_params
{
public:
...
/**
 * \detail hitLambert2D_DiffRays 
 *
 * modifies the raydata according to the parameters of the scatter
 *
 * \param[in] diffRayStruct &prd, Mat_DiffRays_hitParams hitParams, ScatLambert2D_DiffRays_params params
 * 
 * \return bool
 * \sa 
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitLambert2D_DiffRays(diffRayStruct &prd, Mat_DiffRays_hitParams hitParams, ScatLambert2D_DiffRays_params params)
{
...
//inline RT_HOSTDEVICE bool hitLambert2D(rayStruct &prd, double3 p_normal, ScatLambert2D_params params)
//{
//	uint32_t x1[5];
...
//	double specAngle=acos(dot(normalize(eIn1),-p_normal)); // calc angle of specular reflection to normal
