...
rtDeclareVariable(ConePipe_DiffRays_ReducedParams, params, , ); // normal vector to surface. i.e. part of the definition of the plane surface geometry
...
{
  return calcHitParamsConePipe_DiffRays(prd.position+t*prd.direction, params);
}
