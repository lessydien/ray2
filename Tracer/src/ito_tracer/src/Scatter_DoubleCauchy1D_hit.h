...
#ifndef SCATTER_DOUBLECAUCHY1D_HIT_H
  #define SCATTER_DOUBLECAUCHY1D_HIT_H
...
/* declare class */
/**
  *\class   ScatDoubleCauchy1D_params
  *\ingroup Scatter
  ...
  *
  */
class ScatDoubleCauchy1D_params: public Scatter_ReducedParams
{
public:
...
/**
 * \detail hitDoubleCauchy1D 
 *
 * modifies the raydata according to the parameters of the scatter
 *
 * \param[in] rayStruct &prd, Mat_hitParams hitParams, ScatDoubleCauchy1D_params params
 * 
 * \return bool
 * \sa 
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitDoubleCauchy1D(rayStruct &prd, Mat_hitParams hitParams, ScatDoubleCauchy1D_params params)
{
	ScatDoubleCauchy1D_params test=params;
	uint32_t x1[5];
