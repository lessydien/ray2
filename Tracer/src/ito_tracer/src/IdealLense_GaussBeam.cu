...
RT_PROGRAM void intersect(int)
{
  ...
  t.t_baseRay=intersectRayIdealLense(prd.baseRay.position, prd.baseRay.direction, params);
  ...
  if( rtPotentialIntersection( (float)t.t_baseRay ) ) 
  {
    ...
    t.t_waistRayX=intersectRayIdealLense(prd.waistRayX.position, prd.waistRayX.direction, params);
    t.t_waistRayY=intersectRayIdealLense(prd.waistRayY.position, prd.waistRayY.direction, params);
    t.t_divRayX=intersectRayIdealLense(prd.divRayX.position, prd.divRayX.direction, params);
	t.t_divRayY=intersectRayIdealLense(prd.divRayY.position, prd.divRayY.direction, params);
	/**************************************************************************************************************/
