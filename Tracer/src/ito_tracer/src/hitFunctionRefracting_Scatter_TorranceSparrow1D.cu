...
__forceinline__ __device__ void refractingScatTorrSparr1D_anyHit_device()
{
...
__forceinline__ __device__ void refractingScatTorrSparr1D_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  refractingScatTorrSparr1D_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  refractingScatTorrSparr1D_closestHit_device( hitParams, t_hit ); 
}
