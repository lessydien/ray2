 ...
 * \author Mauch
 */
MaterialError MaterialVolumeScatter::createOptiXInstance(RTcontext context, RTgeometryinstance &instance, int index, simMode mode, double lambda)
{
 ...
 * \author Mauch
 */
MaterialError MaterialVolumeScatter::updateOptiXInstance(RTcontext context, RTgeometryinstance &instance, int index, simMode mode, double lambda)
{
