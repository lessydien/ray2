...
/**\file MaterialVolumeScatter.cpp
 ...
 * \author Mauch
 */
void MaterialVolumeScatter::hit(rayStruct &ray, Mat_hitParams hitParams, double t_hit, int geometryID)
{
...
//	extern Group oGroup;
	...
	if ( hitVolumeScatter(ray, hitParams, this->params, t_hit, geometryID, coat_reflected) )
	{
 ...
 * \author Mauch
 */
MaterialError MaterialVolumeScatter::createCPUSimInstance(double lambda)
{
 ...
 * \author Mauch
 */
MaterialError MaterialVolumeScatter::createOptiXInstance(RTcontext context, RTgeometryinstance &instance, int index, SimParams simParams, double lambda)
{
 ...
 * \author Mauch
 */
MaterialError MaterialVolumeScatter::updateOptiXInstance(RTcontext context, RTgeometryinstance &instance, int index, SimParams simParams, double lambda)
{
 ...
 * \author Mauch
 */
void MaterialVolumeScatter::setParams(MatVolumeScatter_params params)
{
	this->update=true;
	this->params=params;
}
 ...
 * \author Mauch
 */
MatVolumeScatter_params MaterialVolumeScatter::getParams(void)
{
	return this->params;
}
