...
class SphericalSurface_GeomRender : public SphericalSurface
{
  ...
  public:
    ...
    SphericalSurface_GeomRender() :
        SphericalSurface()
	{
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_SphericalSurface_GeomRender.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_SphericalSurface_GeomRender.cu.ptx" );
	}
