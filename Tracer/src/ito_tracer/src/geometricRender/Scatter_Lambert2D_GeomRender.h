...
/**\file Scatter_TorranceSparrow1D_GeomRender.h
* \brief 
* 
*           
* \author Mauch
...
#ifndef SCATTER_LAMBERT2D_GEOMRENDER_H
#define SCATTER_LAMBERT2D_GEOMRENDER_H
...
#define PATH_TO_HIT_SCATTER_LAMBERT2D_GEOMRENDER "_Scatter_Lambert2D_GeomRender"
...
/* declare class */
/**
  *\class   Scatter_TorranceSparrow1D_GeomRender
  *\ingroup Scatter
  *\brief   
  *
  *         
  ...
  *
  */
class Scatter_Lambert2D_GeomRender: public Scatter_Lambert2D
{
	protected:
...
//		ScatLambert2D_scatParams *fullParamsPtr; // complete parameter set
  ...
  public:
    ...
    Scatter_Lambert2D_GeomRender()
	{
		reducedParams.TIR=0;
		/* set ptx path for OptiX calculations */
		path_to_ptx[512];
		sprintf( path_to_ptx, "%s", PATH_TO_HIT_SCATTER_LAMBERT2D_GEOMRENDER );
