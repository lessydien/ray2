...
#ifndef MATERIALABSORBING_GEOMRENDER_HIT_H
#define MATERIALABSORBING_GEOMRENDER_HIT_H
...
/**
  ...
  *
  */
class MatAbsorbing_GeomRender_params : public MatAbsorbing_params
{
public:
...
/**
 * \detail hitAbsorbing_GeomRender 
 *
 * modifies the raydata according to the parameters of the material
 *
 * \param[in] diffRayStruct &ray, Mat_GeomRender_hitParams hitParams, double t_hit, int geomID
 * 
 * \return bool
 * \sa 
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitAbsorbing_GeomRender(geomRenderRayStruct &ray, Mat_GeomRender_hitParams hitParams, double t_hit, int geomID)
{
