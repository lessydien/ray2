...
/* declare class */
/**
  *\class   ScatLambert2D_GeomRender_params
  *\ingroup Scatter
  ...
  *
  */
//class ScatLambert2D_GeomRender_params: public ScatLambert2D_params
//{
//public:
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitLambert2D_GeomRender(geomRenderRayStruct &prd, Mat_hitParams hitParams, ScatLambert2D_params params)
{
