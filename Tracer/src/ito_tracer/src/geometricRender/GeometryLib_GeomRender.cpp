...
//		break;
	...
	case GEOM_ASPHERICALSURF:
		l_pGeometry=new AsphericalSurface_GeomRender(1);
		break;
//	case GEOM_CYLLENSESURF:
//		l_pGeometry=new CylLenseSurface(1);
//		break;
	case GEOM_CYLPIPE:
		l_pGeometry=new CylPipe_GeomRender(1);
		break;
	case GEOM_CONEPIPE:
		l_pGeometry=new ConePipe_GeomRender(1);
		break;
	case GEOM_IDEALLENSE:
		l_pGeometry=new IdealLense_GeomRender(1);
		break;
	case GEOM_APERTURESTOP:
		l_pGeometry=new ApertureStop_GeomRender(1);
		break;
	case GEOM_CADOBJECT:
		l_pGeometry=new CadObject_GeomRender(1);
		break;
	//case GEOM_SUBSTRATE:
