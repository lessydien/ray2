...
__forceinline__ __device__ Mat_GeomRender_hitParams calcHitParams(double t)
{
...
{
	  double t=intersectRayPlaneSurface_GeomRender(prd.position, prd.direction, params);
