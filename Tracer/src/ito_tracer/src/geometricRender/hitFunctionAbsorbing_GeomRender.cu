...
__forceinline__ __device__ void absorbingGeomRender_anyHit_device()
{
...
__forceinline__ __device__ void absorbingGeomRender_closestHit_device( Mat_GeomRender_hitParams hitParams, double t_hit )
{
...
RT_PROGRAM void anyHit()
{
  ...
  absorbingGeomRender_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  absorbingGeomRender_closestHit_device( hitParams, t_hit );
}
