...
private:
  ...
  public:
    ...
    CadObject_GeomRender() :
        CadObject()
	{
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_CadObject_GeomRender.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_CadObject_GeomRender.cu.ptx" );
	  type=GEOM_PLANESURF;
	}
