...
rtDeclareVariable(StopArraySurface_ReducedParams, params, , ); // centre of spherical surface
...
{
  return calcHitParamsStopArraySurface(prd.position+t*prd.direction, params);
}

RT_PROGRAM void intersect(int)
{ 

	double t=intersectRayStopArraySurface(prd.position,prd.direction,params);
