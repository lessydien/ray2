...
#ifndef SCATTER_TORRANCESPARROW2D_PATHTRACE_HIT_H
  #define SCATTER_TORRANCESPARROW2D_PATHTRACE_HIT_H
...
/* declare class */
/**
  *\class   ScatTorranceSparrow2D_PathTrace_params
  *\ingroup Scatter
  ...
  *
  */
class ScatTorranceSparrow2D_PathTrace_params: public ScatTorranceSparrow2D_params
{
public:
 ...
 * \author Mauch
 */
inline RT_HOSTDEVICE bool hitTorranceSparrow2D_PathTrace(rayStruct_PathTracing &prd, Mat_hitParams hitParams, ScatTorranceSparrow2D_PathTrace_params params)
{

	uint32_t x1[5];
	ScatTorranceSparrow2D_PathTrace_params test=params;
