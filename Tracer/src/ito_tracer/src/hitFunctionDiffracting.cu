...
__forceinline__ __device__ void diffracting_anyHit_device()
{
...
__forceinline__ __device__ void diffracting_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  diffracting_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  diffracting_closestHit_device( hitParams, t_hit );
}
