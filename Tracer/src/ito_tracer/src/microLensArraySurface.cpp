 ...
 * \author Mauch
 */
geometryError MicroLensArraySurface::createOptixInstance( RTcontext &context, RTgeometrygroup &geometrygroup, int index, simMode mode, double lambda )
{
 ...
 * \author Mauch
 */
geometryError MicroLensArraySurface::updateOptixInstance( RTcontext &context, RTgeometrygroup &geometrygroup, int index, simMode mode, double lambda )
{
	if (this->update)
	{
 ...
 * \author Mauch
 */
geometryError MicroLensArraySurface::parseXml(pugi::xml_node &geometry, simMode mode, vector<Geometry*> &geomVec)
{
	Parser_XML l_parser;
