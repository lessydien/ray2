...
class ApertureArraySurface : public virtual Geometry
{
  ...
  public:
    ...
    ApertureArraySurface()
	{
	  ...
	  sprintf( this->path_to_ptx_intersect, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_ApertureArraySurface.cu.ptx" );
	  sprintf( this->path_to_ptx_boundingBox, "%s" PATH_SEPARATOR "%s", PATH_TO_PTX, "ITO-MacroSim_generated_ApertureArraySurface.cu.ptx" );
