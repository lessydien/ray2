...
__forceinline__ __device__ void reflectingPhong_anyHit_device()
{
...
__forceinline__ __device__ void reflectingPhong_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
	// reflect ray
	hitReflecting(prd, hitParams, t_hit, geometryID, true);

	// scatter ray
	hitPhong(prd, hitParams, scatterParams);
...
{
  reflectingPhong_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  reflectingPhong_closestHit_device( hitParams, t_hit ); 
}
