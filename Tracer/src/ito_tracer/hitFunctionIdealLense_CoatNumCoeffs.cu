...
__forceinline__ __device__ void idealLenseCoatNumCoeffs_anyHit_device()
{
...
__forceinline__ __device__ void idealLenseCoatNumCoeffs_closestHit_device( Mat_hitParams hitParams, double t_hit )
{
...
{
  idealLenseCoatNumCoeffs_anyHit_device();
}


RT_PROGRAM void closestHit()
{
  idealLenseCoatNumCoeffs_closestHit_device( hitParams, t_hit );
}
