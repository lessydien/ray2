...
/* exp */
//OPTIXU_INLINE RT_HOSTDEVICE double3 expf(double3 v)
//{
//  return make_double3(expf(v.x), expf(v.y), expf(v.z));
//}

/* clamp */
//OPTIXU_INLINE RT_HOSTDEVICE double clamp(double f, double a, double b)
//{
...
OPTIXU_INLINE RT_HOSTDEVICE double3 make_double3(double v0, double2 v1) { return make_double3( v0, v1.x, v1.y ); }
OPTIXU_INLINE RT_HOSTDEVICE double4 make_double4(double v0, double v1, double2 v2) { return make_double4( v0, v1, v2.x, v2.y ); }
OPTIXU_INLINE RT_HOSTDEVICE double4 make_double4(double v0, double2 v1, double v2) { return make_double4( v0, v1.x, v1.y, v2 ); }
OPTIXU_INLINE RT_HOSTDEVICE double4 make_double4(double2 v0, double v1, double v2) { return make_double4( v0.x, v0.y, v1, v2 ); }
