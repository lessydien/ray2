 ...
 ***********************************/
  ...
  * RT_ERROR_LAUNCH_FAILED may be returned if a previous call to @ref rtContextLaunch
  * failed.
  * 
  ...
  * the last compilation, @ref rtContextCompile and @ref rtContextLaunch will not perform
  * a recompilation.
  * 
  ...
  * <B>Description</B>
  * 
  * @ref rtContextLaunch functions execute the computation kernel associated with the
  * given context.  If the context has not yet been compiled, or if the context has been
  * modified since the last compile, @ref rtContextLaunch will recompile the kernel
  ...
  * <B>History</B>
  * 
  * @ref rtContextLaunch was introduced in OptiX 1.0.
  * 
  * <B>See also</B>
 ...
 ***********************************/
  ...
  * The current builder can be changed at any time, including after a call to @ref rtContextLaunch.
  ...
  * the @ref rtContextLaunch functions, and its dirty flag will be reset. The dirty flag will also
 ...
 ***********************************/
  ...
  * @ref rtContextLaunch the flag is automatically cleared.  When the dirty
  * flag is set, the geometry data is uploaded automatically to the device
  * while a @ref rtContextLaunch call.
  * 
  ...
  * After a call to @ref rtContextLaunch the flag is automatically set to
  * \a 0. When the dirty flag is set, the geometry data is uploaded
  * automatically to the device while a @ref rtContextLaunch call.
  * 
 ...
 ***********************************/
  ...
  */
  ...
  /**
  * @brief Side texture ID of this texture sampler
  * 
  * @ingroup TextureSampler
  * 
  * <B>Description</B>
 ...
 ***********************************/
  ...
  * <B>Description</B>
  * 
  * @ref rtBufferUnmap unmaps a buffer from the host after a call to @ref rtBufferMap.  @ref rtContextLaunch* cannot be called
